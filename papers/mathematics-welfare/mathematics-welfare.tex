...
The disparity is not peculiar to one campus. In the United States, universities awarded about 2{,}250 doctorates in mathematics and statistics in 2022 \citep{nsfsed2025}, against roughly 30{,}000 law degrees \citep{aba2024} and roughly 200{,}000 master's degrees in business \citep{nces2023}. On the research side, the National Science Foundation's Division of Mathematical Sciences requested \$248 million for fiscal year 2025 \citep{nsf2025}, about one part in a hundred thousand of national output.

At the time, I recall being persuaded against further pursuit of mathematics. The professors who taught me bemoaned what they felt was a gutting of the profession - something roughly equivalent to a halving of real income over a generation.\footnote{The feeling was of lost standing rather than lost purchasing power, and the measured fall depends on the yardstick. Adjusted for inflation, an Australian professor's salary fell 12 per cent between 1977 and 2002 \citep{robinson2005}; measured against average weekly earnings the same series shows a fall of about a third, most of it between 1977 and 1990 \citep{horsley2002}, and Chapman's submission to the 2002 inquiry into higher education documents the same two decades of declining relativities \citep{chapman2002}. Against the professions the students down the hill were joining, the gap opened further. Nor was it peculiar to Australia: real faculty salaries in the United States in 1990--91 were still about 8 per cent below 1971--72 \citep{aha1991}.} I did pursue a doctorate, as it happens, but neither I nor anyone else from that small class went on to work on what I will term ``unmotivated mathematics''. Australia is not necessarily representative, but I suspect not entirely unusual either.
...
The high column is not a forecast; it shows the range once the channels compound. The low column, with a reach multiplier of three, a weak cost channel, and a modest lag improvement, moves the ratio by a factor of nearly eight. The central column moves it by two orders of magnitude at elasticity one; any $\gamma$ above zero moves it further. A reach multiplier near one would mean a bilingual person was already present at most uses, and the case studies say otherwise.
...
I have editorialized by means of a simple model that society needs more investment in pure mathematics. Fewer than one person in a hundred thousand is attempting to race ahead of the applications needed by the rest. For every Einstein we need a Gauss, a Riemann, a Levi-Civita and a Grossmann. The opportunity cost without them is unseen, censored evidence.
...
\bibitem[Chapman(2002)]{chapman2002}
Chapman, B. (2002).
\newblock A submission on financing issues to the Department of Education Science and Training inquiry into higher education.
\newblock Centre for Economic Policy Research Discussion Paper 456, Australian National University.
