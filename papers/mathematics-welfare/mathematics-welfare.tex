...
I tested this. I put each of the nine cases to a separate, fresh instance of Claude (Fable 5.1), asking the question a practitioner in one field would ask, in that field's terms only: is this quantity known under another name elsewhere, and what is the exact relationship? I switched web search off and limited answers to 150 words. All nine answers named the other literatures and stated the relationship, usually with the identity and the dates. The prompts and answers are recorded with the paper. All nine identifications are in the literature the model was trained on, so the test shows a model carrying a known identification across a vocabulary boundary, not making a new one.
