...
I spent the next three decades as an applied mathematician, albeit one with a love and respect for pure mathematics. I have witnessed on countless occasions the failure of businesses to recognize the abstract structure of their operations or the benefit that might accrue from appropriate framing. Examples include the market-maker who does not realize they are solving a control problem and denying themselves that rich set of techniques, or the data teams who perform unwitting ad-hoc filtering or Bayesian statistics. My profession is littered with ad hoc attempts at everything from shrinkage to harmonic analysis, and yet it is regarded as one of the more quantitative fields by far. The default is to {\em never} formalize.

What is really new? Consider backpropagation, gaussian process regression, softmax classifiers, Kalman filtering, attention, message passing, random features, contrastive learning, learning to rank, synthetic controls, value iteration, mirror descent, ensemble uncertainty ... are any of these truly original mathematical structures? All had identical or near-identical predecessors by another name. Finding and inventing new structure is difficult. Working at the highest level of abstraction is physically hard. Too hard for me, as it happens. I moved to applied work early on in my Ph.D.

Given the societal debt, the irritation to pure mathematicians caused by nonchalant announcements of AI-generated counter-examples from technologists is more than understandable.
...
Conversely, it is hard to think of a major industry that does not stand upon pure mathematical foundations. It is intuitively efficient from the perspective of society at large for those with ability and drive to perform focussed work that accumulates this lattice over centuries. Waiting until the need arises makes little sense. The need might never be apparent, if the mathematics does not exist (it is hard enough when it does). Just-in-time pure mathematics is rarely viable. The odds that the beneficiary will also have the awareness, talent and time to solve the problem on the fly is remote. That would be like expecting Einstein to invent differential geometry. He did not. I speculate that he could not.
